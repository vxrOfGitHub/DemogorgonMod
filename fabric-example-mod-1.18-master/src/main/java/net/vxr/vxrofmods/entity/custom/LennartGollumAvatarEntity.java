...
public class LennartGollumAvatarEntity extends TameableEntity implements IAnimatable {

    private static final Item TamingItem = Items.COD;
    private static final Item ArmorItem = ModItems.LENNART_GOLLUM_HELMET;
    ...
    private static final String sittingAnimation = "animation.gollum.sit";
    private static final String walkAnimation = "animation.gollum.walking";
    private static final String idleAnimation = "animation.gollum.standing";

    private AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public LennartGollumAvatarEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    private static final TrackedData<Boolean> SITTING =
            DataTracker.registerData(LennartGollumAvatarEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private static final TrackedData<Boolean> DANCING =
            DataTracker.registerData(LennartGollumAvatarEntity.class, TrackedDataHandlerRegistry.BOOLEAN);


    private static boolean musicIsPlayingNear(List<BlockState> nearJukeboxes, LennartGollumAvatarEntity entity) {
