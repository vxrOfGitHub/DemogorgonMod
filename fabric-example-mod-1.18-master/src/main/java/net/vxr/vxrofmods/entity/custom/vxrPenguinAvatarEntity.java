...
public class vxrPenguinAvatarEntity extends AnimalEntity implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public vxrPenguinAvatarEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new LookAtEntityGoal(this, PlayerEntity.class, 10));
