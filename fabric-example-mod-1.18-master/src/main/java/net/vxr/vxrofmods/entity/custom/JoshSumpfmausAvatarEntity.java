...
public class JoshSumpfmausAvatarEntity extends TameableEntity implements IAnimatable {
    ...
    private static final Item ArmorItem = ModItems.JOSH_SUMPFMAUS_HELMET;

    private static final boolean hasDanceAnimation = true;
    private static final String dancingAnimation = "animation.josh_sumpfmaus.jump";
    private static final String sittingAnimation = "animation.josh_sumpfmaus.sit";
    private static final String walkAnimation = "animation.josh_sumpfmaus.walk";
    private static final String idleAnimation = "animation.josh_sumpfmaus.idle";

    private AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public JoshSumpfmausAvatarEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    private static final TrackedData<Boolean> SITTING =
            DataTracker.registerData(JoshSumpfmausAvatarEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private static final TrackedData<Boolean> DANCING =
            DataTracker.registerData(JoshSumpfmausAvatarEntity.class, TrackedDataHandlerRegistry.BOOLEAN);


    private static boolean musicIsPlayingNear(List<BlockState> nearJukeboxes, JoshSumpfmausAvatarEntity entity) {
