...
public class PokuCapybaraAvatarEntity extends TameableEntity implements IAnimatable {

    private static final Item TamingItem = Items.CARROT;
    private static final Item ArmorItem = ModItems.POKU_CAPYBARA_HELMET;

    private static final boolean hasDanceAnimation = false;
    private static final String dancingAnimation = "animation.poku_capybara.sit";
    private static final String sittingAnimation = "animation.poku_capybara.sit";
    private static final String walkAnimation = "animation.poku_capybara.walk";
    private static final String idleAnimation = "animation.poku_capybara.idle";

    private AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public PokuCapybaraAvatarEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    private static final TrackedData<Boolean> SITTING =
            DataTracker.registerData(PokuCapybaraAvatarEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private static final TrackedData<Boolean> DANCING =
            DataTracker.registerData(PokuCapybaraAvatarEntity.class, TrackedDataHandlerRegistry.BOOLEAN);


    private static boolean musicIsPlayingNear(List<BlockState> nearJukeboxes, PokuCapybaraAvatarEntity entity) {
