...
public class MichelWolfAvatarHelmetItem extends ArmorItem implements IAnimatable {

    private static final Item TamingItem = Items.BONE;
    private static final EntityType<?> avatarEntity = ModEntities.MICHEL_WOLF;
    private static final String idleAnimation = "animation.michel_wolf_avatar_helmet_item.idle";
    ...
    public MichelWolfAvatarHelmetItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
