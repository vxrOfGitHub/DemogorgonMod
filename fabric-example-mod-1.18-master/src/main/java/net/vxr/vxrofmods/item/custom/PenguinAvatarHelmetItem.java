...
public class PenguinAvatarHelmetItem extends ArmorItem implements IAnimatable {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if(user.getStackInHand(hand).hasNbt()) {
            user.sendMessage(Text.literal(user.getStackInHand(hand).getNbt().getString("vxrofmods.avatar_name")));
        }
        ...
        if (!(world instanceof ServerWorld)) {
            ...
            if (blockState.isOf(Blocks.SPAWNER)) {
                ...
                if (blockEntity instanceof MobSpawnerBlockEntity) {
                    ...
                    EntityType<?> entityType = ModEntities.PENGUIN_AVATAR;
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        // not to actually play it
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.penguin_avatar_helmet_item.idle", true));
        ...
        // full set of armor
            ...
            boolean isWearingAll = armorList.containsAll(Arrays.asList(ModItems.PENGUIN_HELMET) );
