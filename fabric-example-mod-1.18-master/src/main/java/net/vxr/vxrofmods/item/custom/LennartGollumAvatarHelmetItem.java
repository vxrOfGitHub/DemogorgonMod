...
public class LennartGollumAvatarHelmetItem extends ArmorItem implements IAnimatable {

    private static final Item TamingItem = Items.COD;
    private static final EntityType<?> avatarEntity = ModEntities.LENNART_GOLLUM;
    private static final String idleAnimation = "animation.lennart_gollum_helmet.idle";
    ...
    public LennartGollumAvatarHelmetItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
