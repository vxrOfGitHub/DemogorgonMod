...
public class DemogorgonArmorModel extends GeoModel<DemogorgonArmorItem> {
    @Override
    public Identifier getModelResource(DemogorgonArmorItem animatable) {
        return new Identifier(DemogorgonMod.MOD_ID, "geo/demogorgon_head_helmet.geo.json");
    }
    ...
    public Identifier getAnimationResource(DemogorgonArmorItem animatable) {
        return new Identifier(DemogorgonMod.MOD_ID, "animations/demogorgon_head_helmet.animation.json");
    }
}
